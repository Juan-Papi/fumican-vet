    ...
    <header>
        ...
        <div class="title">
            ...
            <small>#{{ $purchaseNote->id }} &mdash;
                {{ \Carbon\Carbon::parse($purchaseNote->purchase_date)->format('d/m/Y') }}</small>
        </div>
    </header>
    ...
    <main>
        <table class="general-info">
            <tr>
                ...
                <td>{{ $purchaseNote->warehouse->name }}</td>
                <td class="label">Usuario:</td>
                <td>{{ $purchaseNote->user->first_name }} {{ $purchaseNote->user->last_name }}</td>
            </tr>
            <tr>
                <td class="label">Proveedor:</td>
                <td>{{ $purchaseNote->supplier->name }}</td>
